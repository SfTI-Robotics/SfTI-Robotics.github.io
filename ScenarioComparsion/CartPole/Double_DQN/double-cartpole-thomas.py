...
start_focus = 0
end_focus = 0
NAME = 'CartPole-v1_DDQN'
SAVE_PATH = "/Desktop/Py/Scenario_Comparasion/CartPole/Model/" + "DDQN_images/"
...
if __name__ == "__main__":
    ...
    for e in tqdm(range(EPISODES)):
        ...
        record.summarize(e, step, time.time() - start_time, score, 1 - agent.epsilon)
